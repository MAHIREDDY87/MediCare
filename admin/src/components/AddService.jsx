...
const AddService = () => {
    ...
    //to update the image if found.
    const [hasExistingImage, setHasExistingImage] = useState(false);
    //to remove the exisiting image.
    ...
    //Datetime controls for adding slots.
    const now = new Date();
    ...
    //user can't select previous year/month/date which are already passed.
    useEffect(() => {
  ...
  return (
    <div className={addServiceStyles.container.main}>
        <div className={addServiceStyles.toast.container}>
            {toast && (
                <div className={`${addServiceStyles.toast.toastError} ${
                    toast.type === "error"
        ...
        <form onSubmit={handleSubmit} className={addServiceStyles.container.form}>
            <div className="flec flex-col sm:flex-row items-start sm:items-center 
            justify-between mb-6 sm:mb-8 gap-4">
                <div>
                    ...
                    <p className={addServiceStyles.header.subtitle}>
                        Create a beatuiful service card with unique time slots.
                    </p>
                </div>
            ...
            <div className={addServiceStyles.grids.main}>
                <div className="lg:col-span-1 col-span-1 flex flex-col items-center">
                        ...
                        <div className={addServiceStyles.imageUpload.preview}>
                            {imagePreview ?(
                                ...
                                <div className={addServiceStyles.imageUpload.placeholder}>
                                    ...
                                    <div className="mt-2 text-sm">Service image(required)
                                    </div>
                                </div>
                            )}
                        </div>
