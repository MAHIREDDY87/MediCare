...
// this function  returns the date as 27 Aug 2026 
...
//this function takes slot with date time and returns a data.
...
const AppointmentsPage = () => {
    ...
    //filtered by specialty,date & query.
    ...
    //sort the date-time descending order.
    ...
    //display all the  appointment or the filtered ones.
    const displayed = useMemo(
        () => (showAll ? sortedFiltered : sortedFiltered.slice(0, 8)),
        [sortedFiltered, showAll]
  );

  //if admin wants to cancel the appointment
