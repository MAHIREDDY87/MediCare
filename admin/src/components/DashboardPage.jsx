  ...
  //to load doctors from the server
    useEffect(() => {
      ...
      async function loadDoctors() {
        ...
        setError(null);
        try {
          //we use /api/doctors to get doctors from server.js file in backend.
          const url = `${API_BASE}/api/doctors?limit=200`;
          // if response will be stored using url here.
          ...
          // if res.ok doesn't happen.then it will show error.
    ...
    // it will load the patient count here
    useEffect(() => {
      let mounted = true;
        ...
        <div className={s.headerContainer}>
          <div>
            ...
            <p className={s.headerSubtitle}>
              Overveiw of Doctors & appointments
            </p>
          </div>
        </div>
