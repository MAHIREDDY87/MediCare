...
export default function ListServicePage() {
  ...
  // sort the slots as latest slots will come first by date
...
//fetch services from server.
  ...
  //convert array of solts into slot objects.
  ...
  //convert the slot object to timestamp in local time 
