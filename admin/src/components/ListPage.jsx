...
//this function will give DD-MM-YYYY.
function formatDateISO(iso) {
    ...
    // it will normailize any date-like string.
    ...
    //this function gives past dates first that is  nearest date
...
const ListPage = () => {
  ...
  return (
    <div className={doctorListStyles.container}>
        ...
        <main className={doctorListStyles.loadingContainer}>
            { loading && (
            ...
            {displayed.map((doc) => {
                ...
                return (
                    ...
                    <div className={doctorListStyles.articleContent}>
                        <img  
                            src={doc.imageUrl || doc.image || "/doctor-placeholder.png"}
                            alt={doc.name}
                ...
                <div className={doctorListStyles.showMoreContainer}>
                    <button onClick={() => setShowAll((s) => !s)}
                        className={doctorListStyles.showMoreButton}>
                            {showAll ? "Show Less" : `Show More (${filtered.length})`}
                    </button>
                </div>
            )}
        </main>
