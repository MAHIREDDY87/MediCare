...
const Navbar = () => {
    ...
    //to move the NavBar from X-axis
    ...
    //it will be moving 0.12 seconds 
    useLayoutEffect(() => {
        moveIndicator();
        const t = setTimeout(() => {
        moveIndicator();
    ...
    // it will toggle the mobile menu.ie: closes when we click esc button.
    useEffect(() => {
        const onKey = (e) => {
                ...
                <div className={ns.rightContainer}>
                    ...
                    {isSignedIn? (
                       ...
                       <div className="hidden lg:flex items-center gap-2">
                        <button
                            onClick={handleOpenSignIn} className={ns.loginButton + " " + ns.cursorPointer}
                        >
                            Login
                        </button>
                        </div>
