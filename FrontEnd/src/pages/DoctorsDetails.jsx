...
//this functon will parse date into an object
function getScheduleDates(schedule) {
  ...
  //you can get the output as desired that is most recent comes first or the earilest comes first.
}
