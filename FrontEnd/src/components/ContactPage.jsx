...
const ContactPage = () => {
  ...
  //to submit the data and send the message to whatsapp.
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/7386592899?text=${encodeURIComponent(text)}`;
            ...
            <div className={contactPageStyles.infoContainer}>
                <div className={contactPageStyles.infoCard}>
                    ...
                    <p className={contactPageStyles.infoItem}>
                        <Phone size={16}  /> 7386592899
                    </p>

                    <p className={contactPageStyles.infoItem}>
                        <Mail size={16} /> MediCare@yourclinic.com
                    </p>
                </div>

                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122080.996654!2d79.9801474!3d15.5085814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a4b011c10366c03%3A0x6ee40296fd2dbcc5!2sOngole%2C%20Andhra%20Pradesh!5e0!3m2!1sen!2sin!4v1234567890"
